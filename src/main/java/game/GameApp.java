...
public class GameApp extends Application {
    ...
    private static final String GAME_TITLE = "Fat Man!!!!!";
    private static final String GAME_SUBTITLE = "made completly by Nick and no Sebastian";
    private static final String MSG_READY = "get ready to initiate goon warp drives..";
    private static final String MSG_DEAD = "bro couldn't even pass one level";
    private static final String MSG_WIN = "you won but it doesnt matter because you're still a chud";
    ...
    private void initGame() {
        ...
        ghosts = new ArrayList<>(List.of(new Shadow(map), new Patrol(map), new Shy(map), new Ambush(map))); // edited to
                                                                                                            // add new
                                                                                                            // patrol
        // map
    ...
    private void updatePlaying(double dt) {
        ...
        if (earned > 0) {
            ...
            if (bonusItems.isEmpty() && dotsEaten >= config.bonusThreshold) {
                ...
                bonusItems.add(new CanvasBonus(bx, by));
            }
        }
