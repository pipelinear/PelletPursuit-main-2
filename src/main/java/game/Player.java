...
public class Player extends Sprite {
    ...
    public void update(double dt, GameMap map) {
        ...
        // y = ny;
        // }
        // movement happens IF the next tile is outside the griud OR it is not a wall
        // pacman can move if the next tile is outside the grid( Which allows him to go
        // through the side wrap aroud
        // tunnels) OR if ti next tile is nto a wall)
        boolean canMove = map.isOutOfGrid(nc, nr) || !map.isWall(nc, nr); // TC
